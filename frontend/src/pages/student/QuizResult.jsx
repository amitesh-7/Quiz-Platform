    ...
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-3 sm:px-4 pb-6 sm:pb-8">
        ...
        >
          ...
          >
            <span
              className={`text-2xl sm:text-4xl font-bold ${gradeInfo.color}`}
            >
              {gradeInfo.grade}
            </span>
          </div>
        ...
        >
          ...
          <div className="space-y-3 sm:space-y-4">
            {result.detailedResults.map((item, index) => {
              ...
              const getStatusIcon = () => {
                if (!item.isAttempted)
                  return <FiAlertCircle className="w-4 h-4 sm:w-5 sm:h-5" />;
                if (item.isCorrect)
                  return <FiCheckCircle className="w-4 h-4 sm:w-5 sm:h-5" />;
                if (item.isPartial)
                  return <FiAward className="w-4 h-4 sm:w-5 sm:h-5" />;
                ...
                >
                  <div className="flex items-start gap-2 sm:gap-3 mb-3 sm:mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-white text-sm sm:text-base leading-relaxed whitespace-pre-wrap break-words">
                        {item.questionText}
                      </div>
                    </div>
                  </div>
                            ...
                            return (
                              ...
                              >
                                <span className="font-medium flex-shrink-0 w-8">
                                  (
                                  {hindiLabels[optIndex] ||
                                    englishLabels[optIndex]}
                                  )
                                </span>
                                <span className="flex-1 text-sm sm:text-base whitespace-pre-wrap break-words">
                                  {option}
                                </span>
                                {isCorrect && (
                  ...
                  {item.questionType === "written" && (
                    <div className="space-y-3">
                      ...
                      >
                        ...
                        >
                          Marks Awarded:{" "}
                          {item.earnedMarks || item.awardedMarks || 0}/
                          {item.marks}
